...
$108/95/97$ of them on the three survivors, an even spread, because each transfer targets a random
survivor. The drain time is unchanged because the bottleneck is the serial leaver---one node hands its
